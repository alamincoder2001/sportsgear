        ...
        try{
            ...
            foreach($data->cart as $cartProduct){
                ...
                $this->db->query("
                    ...
                    and color_id = ?
                    and branch_id = ?
                ", [$cartProduct->quantity, $cartProduct->productId, $cartProduct->size_id, $cartProduct->color_id, $this->session->userdata('BRANCHid')]);
            }
        ...
        try{
            ...
            foreach($currentSaleDetails as $product){
                $this->db->query("
                    ...
                    and color_id = ?
                    and branch_id = ?
                ", [$product->SaleDetails_TotalQuantity, $product->Product_IDNo, $product->size_id, $product->color_id, $this->session->userdata('BRANCHid')]);
            }
        ...
        $saleDetails = $this->db->query("
            select
                ...
                (
                    ...
                    and srd.size_id = sd.size_id
                    and srd.color_id = sd.color_id
        ...
        try{
            ...
            foreach($oldDetails as $product) {
                $this->db->query("
                    ...
                    and color_id = ?
                    and branch_id = ?
                ", [$product->SaleReturnDetails_ReturnQuantity, $product->SaleReturnDetailsProduct_SlNo, $product->size_id, $product->color_id, $this->session->userdata('BRANCHid')]);
            }
    ...
    public function getSaleReturns() {
        ...
        if(isset($data->id) && $data->id != '') {
            ...
            $res['returnDetails'] = $this->db->query("
                ...
                join tbl_size s on s.Size_SlNo = srd.size_id
                join tbl_color c on c.color_SiNo = srd.color_id
