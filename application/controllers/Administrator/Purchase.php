...
class Purchase extends CI_Controller
{
        ...
        $purchaseDetails = $this->db->query("
            select 
                ...
                (
                    ...
                    and prd.size_id = pd.size_id
                    and prd.color_id = pd.color_id
            ...
            left join tbl_size s on s.Size_SlNo = pd.size_id
        ...
        try{
            ...
            foreach($data->cart as $product){
                ...
                $this->db->query("
                    ...
                    and color_id = ?
                    and branch_id = ?
                ", [$product->return_quantity, $product->Product_IDNo, $product->size_id, $product->color_id, $this->session->userdata('BRANCHid')]);
            }
        ...
        try{
            ...
            foreach($oldDetails as $product) {
                $this->db->query("
                    ...
                    and color_id = ?
                    and branch_id = ?
                ", [$product->PurchaseReturnDetails_ReturnQuantity, $product->PurchaseReturnDetailsProduct_SlNo, $product->size_id, $product->color_id, $this->session->userdata('BRANCHid')]);
            }
    ...
    public function addPurchase()
    {
        ...
        try{
            ...
            foreach($data->cartProducts as $product){
                ...
                $inventoryCount = $this->db->query("select * from tbl_currentinventory where product_id = ? and size_id = ? and color_id = ? and branch_id = ?", [$product->productId, $product->size_id, $product->color_id,  $this->session->userdata('BRANCHid')])->num_rows();
                if($inventoryCount == 0){
                    $inventory = array(
                    ...
                    $this->db->query("
                        ...
                        and color_id = ? 
                        and branch_id = ?
                    ", [$product->quantity, $product->productId,  $product->size_id, $product->color_id, $this->session->userdata('BRANCHid')]);
                }
    ...
    public function updatePurchase()
    {
        ...
        try{
            ...
            foreach($oldPurchaseDetails as $product){
                $previousStock = $this->mt->productStock($product->Product_IDNo, $product->size_id, $product->color_id);
    ...
    function addDamage()
    {
        ...
        try {
            ...
            $this->db->query("
                ...
                and color_id = ? 
                and ci.branch_id = ?
            ", [$data->DamageDetails_DamageQuantity, $data->Product_SlNo, $data->size_id, $data->color_id, $this->session->userdata('BRANCHid')]);
    ...
    public function updateDamage(){
        ...
        try {
            ...
            $this->db->query("
                ...
                and color_id = ? 
                and ci.branch_id = ?
            ", [$oldProduct->DamageDetails_DamageQuantity, $oldProduct->Product_SlNo, $oldProduct->size_id, $oldProduct->color_id, $this->session->userdata('BRANCHid')]);
    ...
    public function getDamages(){
        ...
        $damages = $this->db->query("
            ...
            join tbl_size s on s.Size_SlNo = dd.size_id
            join tbl_color c on c.color_SiNo = dd.color_id
    ...
    public function getPurchaseReturns() {
        ...
        if(isset($data->id) && $data->id != '') {
            ...
            $res['returnDetails'] = $this->db->query("
                ...
                from tbl_purchasereturndetails prd
                join tbl_product p on p.Product_SlNo = prd.PurchaseReturnDetailsProduct_SlNo
                join tbl_size s on s.Size_SlNo = prd.size_id
                join tbl_color c on c.color_SiNo = prd.color_id
