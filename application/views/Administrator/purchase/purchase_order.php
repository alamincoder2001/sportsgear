...
new Vue({
    ...
    methods: {
        ...
        addToCart() {
            ...
            let cartInd = this.cart.findIndex(p => p.productId == this.selectedProduct.Product_SlNo && p
                .size_id == this.selectedSize.Size_SlNo && p.color_id == this.selectedColor.color_SiNo);
            if (cartInd > -1) {
